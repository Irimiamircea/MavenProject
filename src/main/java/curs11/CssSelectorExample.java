...
public class CssSelectorExample extends BaseTest {
	...
	public void cssSelectorTest() {
		...
		//div[class='logo_slogan'] -->c auta orice element care are class = logo_slogan
		...
		//div.column-1_2 h3.sc_title                  Acelasi lucru dar scris diferit
		//div[class = 'column-1_2'] h3.sc_title
		//div[class = 'column-1_2'] h3[class = 'sc_ttitle']
